Shader "Perchang/PeopleOcclusion_fullRendering"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float4 stencilCol = tex2D(_OcclusionStencil, i.uv3);
                
                //float occlusionDepth = tex2D(_OcclusionDepth, i.uv2) * 0.625; //0.625 hack occlusion depth based on real world observation
                float occlusionDepth = tex2D(_OcclusionDepth, i.uv) * 0.625; //0.625 hack occlusion depth based on real world observation
